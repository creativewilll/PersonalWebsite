...
export const ComparisonTable = () => {
  ...
  const leftParallax = useTransform(scrollYProgress, [0, 1], [100, -100]);
  const cardsParallax = useTransform(scrollYProgress, [0, 1], [50, -50]);
  const colY = useTransform(scrollYProgress, [0, 1], [100, -100]);
  ...
  return (
    <section ref={containerRef} className="py-32 sm:py-48 bg-[var(--color-bg)] border-t border-[var(--color-border)] overflow-hidden relative">
      <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-[var(--color-primary)]/5 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-[var(--color-secondary)]/5 rounded-full blur-[150px] pointer-events-none" />
