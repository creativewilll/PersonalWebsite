---
title: "The 'Sky' Voice Scandal: Scarlett Johansson vs. OpenAI and the Sound of Trust Breaking"
slug: "sky-voice-scandal-scarlett-johansson-openai"
date: "2024-05-22"
...
featured: false
draft: false
excerpt: "Scarlett Johansson calls out OpenAI for copying her voice without consent. The Sky voice controversy exposes deeper cracks in AI trust and celebrity rights."
coverImage: "/images/blog/sky-voice-scandal-scarlett-johansson-openai.png"
seoTitle: "Scarlett Johansson vs OpenAI: Sky Voice Scandal Explained | William Spurlock"
seoDescription: "Why Scarlett Johansson is taking on OpenAI over the Sky voice. The legal, ethical, and trust implications of AI voice cloning without consent."
seoKeywords:
...
# AIO/AEO Fields
aioTargetQueries:
  - "What is the Scarlett Johansson OpenAI controversy"
  - "Why did OpenAI pause Sky voice"
  - "Is OpenAI Sky voice based on Scarlett Johansson"
  - "AI voice likeness legal issues"
  - "celebrity voice rights AI"
contentCluster: "ai-safety-policy"
pillarPost: false
parentPillar: "ai-safety-ethics-guide"
entityMentions:
  - "William Spurlock"
  - "Scarlett Johansson"
  - "OpenAI"
...
1. **[What Just Happened: The Sky Voice Controversy in 60 Seconds](#what-just-happened)** — A rapid-fire summary of how Scarlett Johansson ended up in a public fight with the most powerful AI company on earth.

2. **[Johansson's Statement: 'I Was Shocked and Angered'](#johanssons-statement)** — Breaking down her public response, what she claims OpenAI did, and why the timing matters.

3. **[The 'Her' Connection: Why This Voice Feels Familiar](#the-her-connection)** — The uncanny similarity between Sky and Samantha from Spike Jonze's 2013 film, and why Sam Altman keeps referencing that movie.

4. **[The Timeline: When Did OpenAI Approach Johansson?](#the-timeline)** — Mapping the sequence of events from initial contact to GPT-4o demo day.

5. **[OpenAI's Response: Denial, Pause, and PR Spin](#openais-response)** — What OpenAI claims about Sky's origins and why their official statement raises more questions.

6. **[The Legal Minefield: Voice Likeness and Consent](#the-legal-minefield)** — Exploring the messy legal territory around voice rights, publicity rights, and what "inspired by" actually means in court.

7. **[Celebrity IP in the AI Era: A Ticking Time Bomb](#celebrity-ip-in-the-ai-era)** — Why this case is just the beginning of a much larger fight over identity, likeness, and compensation.

8. **[Trust Erosion: What This Means for AI Companies](#trust-erosion)** — How controversies like this damage public trust in AI and why that matters for adoption.

9. **[The Broader Pattern: OpenAI's Controversy Problem](#the-broader-pattern)** — Sky isn't an isolated incident—it's part of a concerning pattern of behavior from the leading AI lab.

10. **[What Builders Should Learn From This](#what-builders-should-learn)** — Practical lessons for developers, founders, and AI product teams about consent, transparency, and ethical AI development.

11. **[The Bottom Line: When AI Gets Too Close to Real](#the-bottom-line)** — Final analysis on where this controversy leaves us and what's likely to happen next.
...
1. **Right of publicity violation** in jurisdictions that include voice within "likeness"
2. **Unfair competition** for effectively appropriating the commercial value of her vocal identity
3. **Deceptive trade practices** if consumers were confused about the voice's origin
4. **Breach of implied contract**—the ethical obligation not to replicate her voice after she declined participation
...
1. **Documented consent frameworks** for any voice training involving identifiable speakers
2. **Clear provenance tracking** showing exactly whose voices trained each model
3. **Opt-out mechanisms** for performers who don't want their voices in training data
4. **Revenue-sharing models** when AI-generated content competes with human performers
5. **Transparency about voice origins** so users know whether they're hearing a real person or a synthesis
