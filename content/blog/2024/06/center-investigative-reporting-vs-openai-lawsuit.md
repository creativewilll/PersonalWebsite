---
title: "Center for Investigative Reporting vs. OpenAI: The Publisher Lawsuits Keep Coming"
slug: "center-investigative-reporting-vs-openai-lawsuit"
date: "2024-06-21"
...
seoKeywords:
  - "OpenAI lawsuit CIR"
  - "publisher sues OpenAI"
  - "AI training data copyright"
  - "journalism AI legal"
  - "OpenAI legal issues"

aioTargetQueries:
  - "why is CIR suing OpenAI"
  - "publisher lawsuits against OpenAI"
  - "AI training data legal issues"
...
1. [The Lawsuit Filed Today](#the-lawsuit-filed-today) — CIR vs. OpenAI and Microsoft: the basics
2. [Who Is the Center for Investigative Reporting](#who-is-the-center-for-investigative-reporting) — The nonprofit newsroom behind Mother Jones and Reveal
3. [What CIR Is Claiming](#what-cir-is-claiming) — Copyright infringement allegations and DMCA violations
4. [The Pattern of Publisher Lawsuits](#the-pattern-of-publisher-lawsuits) — NYT, Tribune, Denver Post: a comparison
5. [OpenAI's Position](#openais-position) — Fair use defense and licensing deals
6. [The Investigative Journalism Angle](#the-investigative-journalism-angle) — Why nonprofit news matters in this fight
7. [Legal Landscape Update](#legal-landscape-update) — Where things stand in June 2024
8. [What This Means for AI](#what-this-means-for-ai) — Broader implications for training data
...
1. **Copyright Infringement**: Direct and vicarious infringement for copying and using CIR's works in training data and model outputs
2. **DMCA Violations**: Removing or altering copyright management information, a separate claim with its own statutory damages
...
[**Book a 15-minute strategy call**](https://williamspurlock.com/contact) and let's talk about what AI automation or a flagship digital experience could do for your business.
