---
title: "Cursor's $900M Series C at $9.9B: The Editor That Became a Platform"
slug: "cursor-series-c-9-9b-valuation"
date: "2025-06-05"
...
featured: false
draft: false
excerpt: "Cursor raises $900M at a $9.9B valuation, just two weeks after shipping Cursor 1.0 with Background Agents GA. Here's what this means for the future of AI-native development."
coverImage: "/images/blog/cursor-series-c-9-9b-valuation.png"
seoTitle: "Cursor $900M Series C at $9.9B Valuation | William Spurlock"
seoDescription: "Cursor raises $900M Series C at $9.9B valuation led by Thrive Capital. With $500M+ ARR and Cursor 1.0 just shipped, here's how an editor became a platform."
seoKeywords:
  - "Cursor Series C"
  - "Anysphere valuation"
  - "Cursor $9.9B"
  - "AI code editor funding"
aioTargetQueries:
  - "Cursor Series C funding"
  - "Anysphere valuation 2025"
  - "how much is Cursor worth"
  - "Cursor vs GitHub Copilot market"
...
- **Jupyter notebook support**: Full support for `.ipynb` files, making Cursor viable for data science and ML workflows
- **Slack integration**: Coding agents that can be summoned directly from Slack channels
...
1. AI coding assistants become a $50+ billion market, and Cursor captures 20%+ of it
2. Cursor's platform moat (Background Agents, Bugbot, MCP ecosystem) creates defensibility that justifies premium multiples
...
1. **A generational shift in developer tools**: The move from text editors to AI-native environments is as significant as the move from command-line to GUI
2. **Network effects and platform potential**: The MCP ecosystem creates defensibility that pure software tools lack
3. **Exceptional founder-market fit**: The Anysphere team (MIT AI Lab alumni) combines deep technical expertise with product intuition
4. **Massive market expansion**: AI assistants don't just capture existing IDE spend — they create new value that expands the total market
