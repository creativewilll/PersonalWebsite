...
export const Problem = () => {
  return (
    <section className="py-24 sm:py-32 relative bg-[var(--color-bg)] overflow-hidden">
      ...
      <div className="absolute top-1/4 -right-[20%] w-[50vw] h-[50vw] bg-[var(--color-secondary)]/5 rounded-full blur-[60px] lg:blur-[150px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 relative">
          {problems.map((item, i) => (
            <motion.div
              ...
              className="bg-[var(--color-surface-dynamic)] backdrop-blur-md lg:backdrop-blur-xl border border-[var(--color-border)] p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] flex flex-col items-start hover:border-[var(--color-primary)]/50 hover:bg-[var(--color-surface-dynamic)] transition-all duration-300 group shadow-lg"
            >
