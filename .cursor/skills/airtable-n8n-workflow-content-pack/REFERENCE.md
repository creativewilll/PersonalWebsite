...
|-------|----------------|--------|
| Blog | `/public/images/blog/{slug}.png` | Wide hero, readable at card size |
...
- `~/.cursor/skills/authoring-blog-posts-v2/AIO_AEO_STRATEGY.md` (if present)  
- `~/.cursor/skills/authoring-blog-posts-v2/SEO_STRATEGY.md` (if present)  
- `~/.cursor/skills/authoring-blog-posts-v2/SKILL.md` or `.cursor/skills/ws-blog-v2-contract/SKILL.md` (frontmatter contract + `serviceTrack`)
