...
2. Read `~/.cursor/skills/authoring-blog-posts-v2/SKILL.md` if present (frontmatter **camelCase** contract). Else `.cursor/skills/ws-blog-v2-contract/SKILL.md`.
3. Read `~/.cursor/skills/authoring-blog-posts-v2/AIO_AEO_STRATEGY.md` if present (lead with answer, question headings, FAQ density).
...
| File | Purpose |
|------|---------|
| `public/images/blog/{slug}.png` | Blog hero: editorial, wide, on-topic abstraction of the automation domain |
